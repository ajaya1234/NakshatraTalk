    ...
    <section>
        <div class="container-fluid-lg">
            ...
            <div class="title" style={{padding:"5px"}}>
                ...
                <p>One of the first components in the Hindu calendar is the Panchang Tithi. However, knowing the date and the lucky moment is crucial at the same time. The time between the Moon's two phases as seen from Earth is known as a tithi. According to astrology, a month has 30 tithis; 15 of these fall under the Shukla Paksha and the other 15 falls under the Krishna Paksha. Sometimes a day will have two Tithi. "Vrishi Tithi" refers to the Tithi that lasts till two sunrises, while "Kshya Tithi" refers to the two Tithis that do not occur at dawn.</p>
            </div>
            <div class="title" style={{padding:"5px"}}>
            ...
            <div class="title" style={{padding:"5px"}}>
               ...
               <p><b>Krishna-Paksha Tithis -</b> Pratipada, Dwitiya, Tritiya, Chaturthi, Panchmi, Shashti, Saptami, Ashtami, Navmi, Dashmi, Ekadashi, Dwadashi, Trayodashi, Chaturdashi, Poornima, Amavasya.</p>
            ...
            <div class="title" style={{padding:"5px"}}>
                ...
                <p>A day is determined by the position of the Sun and the Moon in the night sky. According to astrology, there are 27 yogas, and based on that, the auspicious time of 2023 is ascertained. 9 out of 27 yogas are extremely inauspicious. Nevertheless, the remaining yogas are considered auspicious. Thus, keep in mind to avoid promising work in inauspicious yogas.</p>
            </div>
            <div class="title" style={{padding:"5px"}}>
                <h2>Yoga's name as per astrology</h2>
                  <p><b>Shubh yoga in astrology -</b> Preeti, Ayushman, Saubhagya, Shobhan, Sukarma, Dhriti, Vridhi, Dhruva, Harshana, Siddhi, Variyan, Shiva, Siddha, Sadhya, Shubh, Shukla, Brahma, and Aindra.</p>
