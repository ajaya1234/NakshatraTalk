...
const Zodiac = () => {
  return (
    ...
    <section class="category-section-2" style={{paddingTop: "5px"}}>
        <div class="container-fluid-lg">
             <h1 style={{textalign: "center"}}>SELECT YOUR SIGN </h1>
            <div class="title">
                    ...
                    <div class="category-slider arrow-slider">
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn">
                                <a href="daily_horoscope.html" class="circle-1">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.05s">
                                <a href="daily_horoscope.html" class="circle-2">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.1s">
                                <a href="daily_horoscope.html" class="circle-3">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.15s">
                                <a href="daily_horoscope.html" class="circle-4">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.4s">
                                <a href="daily_horoscope.html" class="circle-4">
                                    <img src="../assets/images/veg-3/category/9.png" class="img-fluid blur-up lazyload"
                                        alt=""/>
                                </a>
                                <div class="category-name">
                                    <h6>Sagittarius</h6>
                          ...
                          <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.45s">
                                <a href="daily_horoscope.html" class="circle-4">
                                    <img src="../assets/images/veg-3/category/10.png" class="img-fluid blur-up lazyload"
                                        alt=""/>
                                </a>
                                <div class="category-name">
                                    <h6>Capricorn</h6>
                         ...
                         <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.5s">
                                <a href="daily_horoscope.html" class="circle-4">
                                    <img src="../assets/images/veg-3/category/11.png" class="img-fluid blur-up lazyload"
                                        alt=""/>
                                </a>
                                <div class="category-name">
                                    <h6>Capricorn</h6>
                         ...
                         <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.55s">
                                <a href="daily_horoscope.html" class="circle-4">
                                    <img src="../assets/images/veg-3/category/12.png" class="img-fluid blur-up lazyload"
                                        alt=""/>
                                </a>
                                <div class="category-name">
                                    <h6>Capricorn</h6>
