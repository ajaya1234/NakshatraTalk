...
{userId ? ( <header class="pb-md-4 pb-0">
          <div class="top-nav top-header sticky-header">
            ...
            <ul  class="flex-row navbar-light">
              ...
              <li class="nav-item">
                <Link style={{color:'black'}} class="nav-link" to="/speaktoaustrology">Speak to Astrologer</Link>
              </li>&nbsp;&nbsp;
              ...
              <li class="nav-item">
                <Link style={{color:'black'}} class="nav-link" to="#">N-Mart</Link>
              </li>&nbsp;&nbsp;
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <Link style={{color:'black'}} class="dropdown-item" to="/vastu">Vastu</Link>
                  </li>
                  <li>
